...
export default {
  ...
  methods: {
    ...
    esSessionEntidad() {
      ...
      switch (url) {
        ...
        case "/AdminUsuarios/COBROS/ADM_RECAUDACION":
          ...
          console.log("entrando al case: "+this.subModulo)
          break;
      }
    },
    ...
    findPrivilegiosByUsuarioIdSession() {
     ...
     findByRecaudadoraId() {
      console.log("obteniendo recaudador 1")
      console.log("estoq  es: "+this.subModulo);
      if (this.subModulo === "ADM_RECAUDACION") {  

      /*Sucursal.getLstSucursalRecaudadorForAddUserByRecaudadorId(30).then(r => {
        this.sucursalesList = r.data.result;
      })*/

          console.log("obteniendo recaudador 2")
