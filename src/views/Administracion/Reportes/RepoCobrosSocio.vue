<template>
    <div>
        <a-card style="width: 100%">
            ...
            <div class="card-head">
                <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <h2>
                        <b style="color: #08632d"> REPORTE COBROS - SOCIO </b>
                    </h2>
                </a-col>
            </div>
            ...
            <a-form>
                <a-row :gutter="1">
                    <a-col :span="5">
                        Filtrar por Rango de Fechas : <a-switch size="small" default-checked
                            v-model="formBusquedav2.filtroRangoFechas" />
                    </a-col>
            ...
            <a-form>
                <a-row :gutter="1">
                    ...
                    <a-col :span="6">
                        ...
                        <a-form-item label="Empresa :" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }"
                            class="a-item-form">
                    ...
                    <a-col :span="6">
                        <a-form-item label="Estado :" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }"
                            class="a-item-form">
        ...
        <a-card style="width: 100%">
            ...
            <a-table :columns="columnCobroSocio" :data-source="lstDataCobroSocio" :pagination="pagination" align="center"
...
const columnCobroSocio = [
    ...
    {
        title: "Sucursal",
        dataIndex: "sucursalBanco",
        key: "sucursalBanco",
        width: "10%",
        scopedSlots: { customRender: "sucursalBanco" },
    },
    {
        title: "Cajero",
        dataIndex: "cajero",
        key: "cajero",
        width: "10%",
        scopedSlots: { customRender: "cajero" },
    },
    {
        title: "Tipo Servicio",
    ...
    },
    {
        title: "Comisión",
        key: "comisionSocio",
        dataIndex: "comisionSocio",
        width: "100px",
        scopedSlots: { customRender: "comisionSocio" },
    },
    {
        title: "Estado",
        key: "estado",
...
export default {
    ...
    methods: {
        findDeudasByParameterForReportv2(page) {
            ...
            ReportesAdmin.findReporteCobroSocio(this.formBusquedav2)
                .then((response) => {
...
//                    this.estadoList.push({ "label": "TODOS", "value": "0" });
        ...
        openModalGenerarReporte() {
            ...
            ReportesAdmin.openModalGenerarReporteSocioAdmin(this.formBusquedav2)
                .then((response) => {
